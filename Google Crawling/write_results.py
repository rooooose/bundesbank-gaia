...
def write_stats(year, i):
  """For given year, converts json files in json dicts, counts how many pdfs were found and doubtful, how many pdfs couldn't be downloaded, and writes everything in the right stats file
